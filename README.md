...
Please complete 1 challenge, and put your code in a public github repo and send that over to our team. Please either deploy your project to the internet (Heroku, etc) or include detailed setup instructions so that we can run it locally.
